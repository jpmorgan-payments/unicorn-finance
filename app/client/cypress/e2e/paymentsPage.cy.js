...
describe("Payments page", () => {
  ...
  it("Submit button selected", () => {
    ...
    cy.contains("Success!");
    cy.contains("Make another payment").click();
    cy.get('[data-cy="amount"]').clear();
  });
  ...
  it("Changing payment type changes changes accounts", () => {
    ...
    cy.get('[data-cy="debtorAccount"]')
      .find(":selected")
      .contains("RAPID AUDIO LLC - 000000010900009");
    cy.get('[data-cy="creditorAccount"]')
      .find(":selected")
      .contains("MORRIS ELECTRIC CONTRACTING LLC - 000000010962009");
    ...
    // Swap to EU SEPA
    cy.get('[data-cy="paymentType"]').select("EU RTP (SEPA)");
    cy.get('[data-cy="debtorAccount"]')
      .find(":selected")
      .contains("6231400596");
    cy.get('[data-cy="creditorAccount"]')
